...
namespace Presentation.Services
{
    public sealed class ObjectDetectionService : IObjectDetectionService, IDisposable
    {
        ...
        private const float ConfidenceThreshold = 0.6f; // порог для "человек"
        private const int NumClasses = 1001; // MobileNetV1 default
